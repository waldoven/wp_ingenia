...
<a class="skip-link screen-reader-text " href="#content"><?php esc_html_e( 'Skip to content', 'fancy-shop' ); ?></a>
<?php do_action('fancy_shop_wp_body_open'); ?>
...
<?php 
	if(is_front_page()  ) { 
		get_template_part( 'templates/header-ad', 'section' ); 
	}
?>
				...
				<div class="container vertical-center">
						...
						<div class="col-md-4 col-sm-4 lr-clear-padding">			
							<ul class="mimi-header-social-icon pull-right animate fadeInRight" >
								<?php if($new_york_business_option['header_myaccount_link']!='' && class_exists('woocommerce')){ echo '<a class="login-register" href="'.esc_url($new_york_business_option['header_myaccount_link']).'">&nbsp;<li class="login-register"><i class="fa fa-user-circle"></i>&nbsp;'.esc_html__("My Account", 'fancy-shop').'</a></li></a>&nbsp;'; ?></li><?php } ?> 					
								<?php if($new_york_business_option['social_facebook_link']!=''){?> <li><a href="<?php echo esc_url($new_york_business_option['social_facebook_link']); ?>" target="<?php if($new_york_business_option['social_open_new_tab']=='1'){echo '_blank';} ?>"  data-toggle="tooltip" title="<?php esc_attr_e('Facebook','fancy-shop'); ?>"><i class="fa fa-facebook"></i></a></li><?php } ?>
								<?php if($new_york_business_option['social_twitter_link']!=''){?> <li><a href="<?php echo esc_url($new_york_business_option['social_twitter_link']); ?>" target="<?php if($new_york_business_option['social_open_new_tab']=='1'){echo '_blank';} ?>"  data-toggle="tooltip" title="<?php esc_attr_e('Twitter','fancy-shop'); ?>"><i class="fa fa-twitter"></i></a></li><?php } ?>
								<?php if($new_york_business_option['social_skype_link']!=''){?> <li><a href="<?php echo esc_url($new_york_business_option['social_skype_link']); ?>" target="<?php if($new_york_business_option['social_open_new_tab']=='1'){echo '_blank';} ?>"  data-toggle="tooltip" title="<?php esc_attr_e('Skype','fancy-shop'); ?>"><i class="fa fa-skype"></i></a></li><?php } ?>
								<?php if($new_york_business_option['social_pinterest_link']!=''){?> <li><a href="<?php echo esc_url($new_york_business_option['social_pinterest_link']); ?>" target="<?php if($new_york_business_option['social_open_new_tab']=='1'){echo '_blank';} ?>"  data-toggle="tooltip" title="<?php esc_attr_e('Pinterest','fancy-shop'); ?>"><i class="fa fa-pinterest"></i></a></li><?php } ?>
							</ul>
						</div>	
