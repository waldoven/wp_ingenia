...
if( !class_exists('new_york_business_settings') ){
	...
	class new_york_business_settings {
		...
		function default_data(){
			...
			'slider_button_text' => __("More details",'fancy-shop'),
			...
			'contact_section_title' => __('Contact us','fancy-shop'),
			'contact_section_background_color' => '#fff',   
			'contact_section_shortcode' => '',
			
			'footer_section_background_color' => '#0c3a80',	
			'footer_section_bottom_background_color' => '#0c3a80',
			'footer_section_bottom_color' => '#fff',
			'footer_foreground_color' => '#fff',		
            'footer_section_bottom_text' =>  __('A Theme by Ceylon Themes','fancy-shop'),			
