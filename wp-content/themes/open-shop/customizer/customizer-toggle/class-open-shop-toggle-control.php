 ...
 * @access public
 */
class Open_Shop_Toggle_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_style( 'open-shop-toggle-control-styles', get_parent_theme_file_uri( 'customizer/customizer-toggle/toggle.css' ), false, '1.0.0', 'all' );
		wp_enqueue_script( 'open-shop-toggle-control-scripts', get_parent_theme_file_uri( 'customizer/customizer-toggle/toggle.js' ), array( 'jquery' ), '1.0.0', true );
	}
	/**
