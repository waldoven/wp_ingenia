 ...
 * @access public
 */
class Open_Shop_WP_Customizer_Range_Value_Control extends WP_Customize_Control {
	...
	public function enqueue(){
		wp_enqueue_script( 'customizer-range-value-control', OPEN_SHOP_THEME_URI . 'customizer/customizer-range-value/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ), '1.0.0', true );
		wp_enqueue_style( 'customizer-range-value-control', OPEN_SHOP_THEME_URI . 'customizer/customizer-range-value/css/customizer-range-value-control.css', array(), '1.0.0' );
	}
	/**
	 * Handles input value.
	 *
 ...
 * @since 1.1.38
 */
function open_shop_sanitize_range_value( $input ){
	if ( open_shop_is_json( $input ) ) {
