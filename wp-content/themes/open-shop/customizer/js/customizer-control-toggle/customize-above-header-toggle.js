...
OPNControlTrigger.addHook( 'open-shop-toggle-control', function( argument, api ) {
		OPNCustomizerToggles ['open_shop_above_header_layout'] = [
		    {
				controls: [
					'open_shop_above_header_col1_set',
					'open_shop_above_header_col2_set',
				    'open_shop_above_header_col3_set',
				    'open_shop_col1_texthtml',
				    'open_shop_col2_texthtml',
				    'open_shop_col3_texthtml',
				    'open_shop_col1_menu_redirect',
				    'open_shop_col2_menu_redirect',
				    'open_shop_col3_menu_redirect',
				    'open_shop_col1_widget_redirect',
				    'open_shop_col2_widget_redirect',
				    'open_shop_col3_widget_redirect',
				    'open_shop_col1_social_media_redirect',
				    'open_shop_col2_social_media_redirect',
				    'open_shop_col3_social_media_redirect',
				    'open_shop_abv_hdr_hgt',
				    'open_shop_abv_hdr_botm_brd',
				    'open_shop_above_brdr_clr',
			...
			},
			{
				...
				callback: function(layout){
					var val = api( 'open_shop_above_header_col1_set' ).get();
...
// col2
			{
				...
				callback: function(layout){
					var val = api( 'open_shop_above_header_col2_set' ).get();
    ...
    // col3

            {
				...
				callback: function(layout){
					var val = api( 'open_shop_above_header_col3_set' ).get();
		...
		OPNCustomizerToggles ['open_shop_above_header_col1_set'] = [
		    
		    {
				...
				callback: function(layout){
                var val = api( 'open_shop_above_header_layout' ).get();
		...
		OPNCustomizerToggles ['open_shop_above_header_col2_set'] = [
		    {
				controls: [    
				'open_shop_col2_texthtml',
				'open_shop_col2_widget_redirect',
		...
		OPNCustomizerToggles ['open_shop_above_header_col3_set'] = [
		    {
				controls: [    
				'open_shop_col3_texthtml',
				'open_shop_col3_widget_redirect',
