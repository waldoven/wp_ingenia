...
class shopping_mart_product_category_widget extends WC_Widget {
		...
		public function form($instance) {
				...
				<?php echo esc_html__('Demo installation data, Unlimited products, WooCommerce products by feature, on sales, featured products, category meta, Top sales, 20+ slider and grid widgets, Go Pro version', 'shopping-mart'); ?>
				</p>
