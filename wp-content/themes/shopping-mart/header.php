				...
				<div class="container vertical-center">
						...
						<div class="col-md-4 col-sm-4 lr-clear-padding">			
							<ul class="mimi-header-social-icon pull-right animate fadeInRight" >
							    <?php if(class_exists('WooCommerce')) { echo '<li class="login-register"><i class="fa fa-user-circle"></i>&nbsp;<a href="'.esc_url($business_store_option['header_myaccount_link']).'" >'.esc_html__('My Account', 'shopping-mart').'</a>  &nbsp;'; } ?>							
