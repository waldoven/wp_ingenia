...
<footer id="colophon" role="contentinfo" class="site-footer  <?php echo esc_attr( $business_store_class );?>" >
  <div class="footer-section <?php echo esc_attr( $business_store_class );?>" >
    ...
    <div class="col-md-12 site-info">
      <p align="center" style="color:#fff;" > <a href="<?php echo esc_url(business_store_THEME_AUTHOR_URL); ?>"> <?php echo esc_html($business_store_option['footer_section_bottom_text']).esc_html__(' - Business Store Theme', 'business-store') ; ?> </a> </p>
    </div>
